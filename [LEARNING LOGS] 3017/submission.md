...
```text
โจทย์ให้คำนวนยอดทั้งหมด รวมvatและcharge

Input:
ยอดใช้จ่ายทั้งหมด

Output:
ราคาทั้งหมดรวมvatและcharge
...
```text
Step 1: รับค่าใช้จ่ายก่อนรวมvatและ
charge
Step 2: เอาค่าใช้จ่ายมารวมcharge
Step 3: ถ้าchargeน้อยกว่า50ให้บวก50 ถ้ามากกว่า1000 บวก1000
Step 4: เอาราคาที่รวมchargeแล้วมารวมvat
```
