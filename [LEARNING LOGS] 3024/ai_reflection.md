...
| OJ submission ID, if submitted | 576152 |
| OJ status | Pass |
...
```text
ถามว่ามีทางอื่นมั้ยที่สามารถเช็คค่าที่น้อยที่สุดได้
```
...
```text
วิธีloopพยายามจะ ไล่ค่า ทีละนิดเข้าหาคำตอบ
```
...
```text
ให้ai สอนใช้ max และกลับไปเปลี่ยนวิธี
```
