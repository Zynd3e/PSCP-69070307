...
```text
Input:
คะแนนรวมและคะแนนสูงสุด

Output:
"Surprising" หรือ "Not surprising"

Constraints:
ถ้าค่ามากสุดกับน้อยสุดห่างกัน2พิมพ์ surprising ถ้าไม่ not surprising
```
...
```text
Step 1: รับค่ามากสุดกับค่ารวม
Step 2: หาคะแนนที่เหลือ
Step 3: ใช้while loopบวกค่านึง และลบอีกค่านึงไปเรื่อยๆจนกว่าจะถึง0หรือไม่เกินค่าสูงสุด
Step 4: print
```
...
```text
หาคะแนนต่ำสุดที่เป็นไปได้โดยใช้ max(0, โหวตที่เหลือ ลบ สูงสุด)
```
