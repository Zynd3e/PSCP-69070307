...
Constraints:
ฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว โดยเปลี่ยนจากฤดูหนาว (winter) เป็นฤดูใบไม้ผลิ (spring) เปลี่ยนจากฤดูใบไม้ผลิ (spring) เป็นฤดูร้อน (summer) เปลี่ยนจากฤดูร้อน (summer) เป็นฤดูใบไม้ร่วง (fall) และเปลี่ยนจากฤดูใบไม้ร่วง (fall) เป็นฤดูหนาว (winter)
...
```text
Step 1: รับค่าวัน/เดือน
Step 2: เช็คว่าเดือนอยู่ช่วงไหน
Step 3: เช็คว่าเป็นเดือนที่3หารลงตัวมั้ย และเช็คว่าเป็นวันที่21ขึ้นไปมั้ย
Step 4: printฤดู
```
