...
```text
Input:
รับค่าจำนวนก้อนอิฐเล็ก,ใหญ่ และระยะทาง

Output:
จำนวนอิฐก้อนเล็กที่ใช้ น้อยที่สุด

Constraints:
ต้องสร้างให้พอดีกับ goal นิ้ว ถ้าก้อนใหญ่มีเกิน ก็ให้ใช้เท่าที่ใช้ได้ แล้วนำก้อนเล็กมาโปะ
```
...
```text
step 1:รับค่าจำนวนก้อนอิฐเล็ก,ใหญ่ และระยะทาง
step 2: คำนวนว่าต้องการก้อนใหญ่กี่ก้อน
step 3:หาระยะที่เหลือหลังใช้ก้อนใหญ่
step 4: เช็คว่าสามารถใช้ก้อนเล็กสร้างจนเสร็จได้หรือไม่
step 5: printจำนวนก้อนเล็กที่ใช้ หรือ-1ถ้าสร้างไม่เสร็จ
```
