...
```text
Input:
โปรแกรมรับจำนวนเต็มบวกหนึ่งค่า n

Output:
บรรทัดเดียว แสดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว (คั่นข้อมูลแต่ละตัวด้วยช่องว่าง)
```
...
```text
Step 1: อ่านจำนวนเต็มบวก n
Step 2: ตรวจว่าระหว่างทางมีกี่ตัวที่หาร 10 ลงตัวโดย num // 10
Step 3: ใช้while loop ในการปริ้นต์และคำนวนโดยใช้จำนวนตัวที่10หารลงตัวคูณ10 แล้วลดจำนวนนั้นเรื่อยๆทีละ1
```
