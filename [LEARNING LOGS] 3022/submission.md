...
ค่าอุณหภูมิ
หน่วยอุณหภูมิก่อน
หน่วยอุณหภูมิที่ต้องการ

Output:
ค่าอุณหภูมิที่ต้องการ
```
...
```text
Step 1: รับค่าอุณหภูมิ และ หน่วยก่อนและหลัง
Step 2: เอาไปเข้าสูตรโดยใช้if else
Step 3: printอุณหภูมิ
```
...
```text
เปลี่ยนไปใช้caseเพราะbranchesเยอะเกิน
```
