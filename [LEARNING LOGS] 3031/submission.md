...
```text
Input:
รับค่าการขยายตัวของน้ำหมึก กับ จำนวนบ้านที่ต้องการความช่วยเหลือ พิกัดบ้านแต่ละหลัง

Output:
วินาทีที่บ้านแต่ละหลังจะโดนน้ำหมึก
```
...
```text
Step 1: รับค่าการขยายตัวของน้ำหมึก กับ จำนวนบ้านที่ต้องการความช่วยเหลือ พิกัดบ้านแต่ละหลัง
Step 2: รับพิกัดบ้านแต่ละหลัง
Step 3: ใช้for loop เพื่อคำนวนวินาทีที่บ้านแต่ละหลังจะโดนน้ำหมึก
Step 4: printวินาที
```
